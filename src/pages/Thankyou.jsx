    ...
    <div className="min-h-screen bg-black text-white flex items-center justify-center px-6 py-16">
      <div className="max-w-xl w-full text-center bg-white/5 border border-white/10 rounded-3xl p-10 shadow-[0_0_30px_rgba(255,215,255,0.25)] backdrop-blur-md">
        ...
        <div className="text-left font-donau text-sm text-gray-200 space-y-3 mb-6">
          ...
          <ol className="list-decimal list-inside space-y-2 text-xs md:text-sm">
            <li>
              ...
              You&apos;ll receive an email shortly with a summary of your
              booking and next-step details.
            </li>
            <li>
              <span className="font-semibold text-amber-200">
                Book your session time:
              </span>{" "}
              The email will include a link to choose a time that works for
              your nervous system and your schedule.
            </li>
            <li>
              <span className="font-semibold text-amber-200">
        ...
        <p className="font-donau text-xs text-gray-400 mb-6">
          If you don&apos;t see an email within 10–15 minutes, please check your
          spam / promotions folder, or reply to your payment receipt so I can
          follow up.
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          <Link
            to="/packages"
            className="flex-1 bg-pink-500/80 hover:bg-pink-400 text-white font-donau py-2 rounded-lg shadow-[0_0_15px_#ff9aff] transition-all text-sm"
          >
            Back to Packages
          </Link>
